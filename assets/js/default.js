...
(function() {
    ...
    const AirdropArchive = window.AirdropArchive || {};
    AirdropArchive.currentFilteredProjects = [];
    AirdropArchive.projects = [];

    function updateProjectCards(projects, page = 1) {
        // Store the filtered projects in the namespace
        AirdropArchive.currentFilteredProjects = projects;
    ...
    function updatePagination(totalPages, currentPage) {
        ...
        prevButton.addEventListener('click', () => {
            if (currentPage > 1) {
                updateProjectCards(AirdropArchive.currentFilteredProjects, currentPage - 1);
            }
        });
        ...
        if (startPage > 1) {
            ...
            firstPage.addEventListener('click', () => {
                updateProjectCards(AirdropArchive.currentFilteredProjects, 1);
            });
        ...
        for (let i = startPage; i <= endPage; i++) {
            ...
            pageButton.addEventListener('click', () => {
                updateProjectCards(AirdropArchive.currentFilteredProjects, i);
            });
        ...
        if (endPage < totalPages) {
            ...
            lastPage.addEventListener('click', () => {
                updateProjectCards(AirdropArchive.currentFilteredProjects, totalPages);
            });
